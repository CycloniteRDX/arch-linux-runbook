...
| Chapter | Purpose |
| --- | --- |
| 00. Installation profile | Define assumptions, substitutions, and the final layout. |
| 01. Pre-installation | Boot the ISO, verify UEFI mode, connect to the network, and confirm the target disk. |
